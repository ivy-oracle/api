...
public class Ftso extends Contract {
    ...
    public static final Event PRICEFINALIZED_EVENT = new Event("PriceFinalized", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>(true) {}, new TypeReference<Uint256>() {}, new TypeReference<Bool>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint8>() {}, new TypeReference<Uint256>() {}));
    ;

    public static final Event PRICEHASHSUBMITTED_EVENT = new Event("PriceHashSubmitted", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Address>(true) {}, new TypeReference<Uint256>(true) {}, new TypeReference<Bytes32>() {}, new TypeReference<Uint256>() {}));
    ;

    public static final Event PRICEREVEALED_EVENT = new Event("PriceRevealed", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Address>(true) {}, new TypeReference<Uint256>(true) {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}));
    ;

    @Deprecated
    protected Ftso(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected Ftso(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected Ftso(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected Ftso(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, transactionManager, contractGasProvider);
    }

    public List<LowTurnoutEventResponse> getLowTurnoutEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(LOWTURNOUT_EVENT, transactionReceipt);
    ...
    public Flowable<LowTurnoutEventResponse> lowTurnoutEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(LOWTURNOUT_EVENT));
        return lowTurnoutEventFlowable(filter);
    }

    public List<PriceEpochInitializedOnFtsoEventResponse> getPriceEpochInitializedOnFtsoEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(PRICEEPOCHINITIALIZEDONFTSO_EVENT, transactionReceipt);
        ArrayList<PriceEpochInitializedOnFtsoEventResponse> responses = new ArrayList<PriceEpochInitializedOnFtsoEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
    ...
    public Flowable<PriceEpochInitializedOnFtsoEventResponse> priceEpochInitializedOnFtsoEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new Function<Log, PriceEpochInitializedOnFtsoEventResponse>() {
            ...
            public PriceEpochInitializedOnFtsoEventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues = extractEventParametersWithLog(PRICEEPOCHINITIALIZEDONFTSO_EVENT, log);
                PriceEpochInitializedOnFtsoEventResponse typedResponse = new PriceEpochInitializedOnFtsoEventResponse();
                typedResponse.log = log;
                typedResponse.epochId = (BigInteger) eventValues.getIndexedValues().get(0).getValue();
                typedResponse.endTime = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
    ...
    public Flowable<PriceEpochInitializedOnFtsoEventResponse> priceEpochInitializedOnFtsoEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
    ...
    public List<PriceFinalizedEventResponse> getPriceFinalizedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(PRICEFINALIZED_EVENT, transactionReceipt);
    ...
    public Flowable<PriceFinalizedEventResponse> priceFinalizedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
    ...
    public List<PriceHashSubmittedEventResponse> getPriceHashSubmittedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(PRICEHASHSUBMITTED_EVENT, transactionReceipt);
        ArrayList<PriceHashSubmittedEventResponse> responses = new ArrayList<PriceHashSubmittedEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
    ...
    public Flowable<PriceHashSubmittedEventResponse> priceHashSubmittedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
    ...
    public List<PriceRevealedEventResponse> getPriceRevealedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(PRICEREVEALED_EVENT, transactionReceipt);
    ...
    public Flowable<PriceRevealedEventResponse> priceRevealedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
    ...
    public RemoteFunctionCall<BigInteger> ASSET_PRICE_USD_DECIMALS() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_ASSET_PRICE_USD_DECIMALS, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }

    public RemoteFunctionCall<TransactionReceipt> activateFtso(BigInteger _firstEpochStartTime, BigInteger _submitPeriod, BigInteger _revealPeriod) {
    ...
    public RemoteFunctionCall<TransactionReceipt> configureEpochs(BigInteger _maxVotePowerNatThresholdFraction, BigInteger _maxVotePowerAssetThresholdFraction, BigInteger _lowAssetUSDThreshold, BigInteger _highAssetUSDThreshold, BigInteger _highAssetTurnoutThresholdBIPS, BigInteger _lowNatTurnoutThresholdBIPS, List<String> _trustedAddresses) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
    ...
    public RemoteFunctionCall<Tuple7<BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, List<String>>> epochsConfiguration() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_EPOCHSCONFIGURATION, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<DynamicArray<Address>>() {}));
        return new RemoteFunctionCall<Tuple7<BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, List<String>>>(function,
                new Callable<Tuple7<BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, List<String>>>() {
                    @Override
                    public Tuple7<BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, List<String>> call() throws Exception {
    ...
    public RemoteFunctionCall<BigInteger> getEpochPriceForVoter(BigInteger _epochId, String _voter) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_GETEPOCHPRICEFORVOTER, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(_epochId), 
    ...
    public RemoteFunctionCall<Tuple6<List<String>, List<BigInteger>, BigInteger, BigInteger, BigInteger, BigInteger>> getVoteWeightingParameters() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_GETVOTEWEIGHTINGPARAMETERS, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<DynamicArray<Address>>() {}, new TypeReference<DynamicArray<Uint256>>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}));
        return new RemoteFunctionCall<Tuple6<List<String>, List<BigInteger>, BigInteger, BigInteger, BigInteger, BigInteger>>(function,
                new Callable<Tuple6<List<String>, List<BigInteger>, BigInteger, BigInteger, BigInteger, BigInteger>>() {
                    @Override
                    public Tuple6<List<String>, List<BigInteger>, BigInteger, BigInteger, BigInteger, BigInteger> call() throws Exception {
                        List<Type> results = executeCallMultipleValueReturn(function);
    ...
    public RemoteFunctionCall<TransactionReceipt> initializeCurrentEpochStateForReveal(BigInteger _circulatingSupplyNat, Boolean _fallbackMode) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
    ...
    public RemoteFunctionCall<BigInteger> priceDeviationThresholdBIPS() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_PRICEDEVIATIONTHRESHOLDBIPS, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteFunctionCall<BigInteger> priceEpochCyclicBufferSize() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_PRICEEPOCHCYCLICBUFFERSIZE, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteFunctionCall<TransactionReceipt> revealPriceSubmitter(String _voter, BigInteger _epochId, BigInteger _price, BigInteger _random, BigInteger _voterWNatVP) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
    ...
    public RemoteFunctionCall<TransactionReceipt> submitPriceHashSubmitter(String _sender, BigInteger _epochId, byte[] _hash) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
    ...
    public RemoteFunctionCall<TransactionReceipt> updateInitialPrice(BigInteger _initialPriceUSD, BigInteger _initialPriceTimestamp) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
    ...
    @Deprecated
    public static Ftso load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new Ftso(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static Ftso load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new Ftso(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static Ftso load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new Ftso(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static Ftso load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
